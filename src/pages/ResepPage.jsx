    ...
    <div>
      ...
      <div className="container">
        ...
        <table id="subjudul-dan-kategori" className="table">
            <tr>
                <td><p className="subjudul">Makanan Side</p></td>
                <td>
                    <div id="DropdownCategory" className="dropdown">
                        <p className="kategori">Kategori:</p>
                        <button id="dropdown-btn" className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Pilih
                        </button>
        ...
        <div id="card" className="row row-cols-1 row-cols-md-3 g-4">
            <div className="col">
                <div className="card">
                    <img src="../assets/corba-api.jpg" className="card-img-top" alt="food_image" />
                    <div id="card-content" className="card-body">
                        <h5 className="card-title">Corba</h5>
                        <table>
                            <tr>
                                <td><p className="card-text">Kategori</p></td>
                                <td><p className="card-text">:</p></td>
                                <td><p className="card-text">Side</p></td>
                            </tr>
                            <tr>
                                <td><p className="card-text">Asal</p></td>
                                <td><p className="card-text">:</p></td>
                                <td><p className="card-text">Turkish</p></td>
                            </tr>
                        </table>
                        <div id="seeMore" className="d-flex justify-content-center">
                            <a className="btn btn-primary" href="#" role="button">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
